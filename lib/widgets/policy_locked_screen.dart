/// Option A — full-screen gate shown when allowLiveCwcInApp is false.
    ...
    return Consumer<SourcePolicyProvider>(
      builder: (context, prov, _) => Scaffold(
        ...
        body: SafeArea(
          child: Column(
            children: [
              const SourcePolicyBannerInline(),
              Expanded(
                child: Center(
                  child: Padding(
...
// Thin inline re-export so policy_locked_screen.dart is self-contained.
class SourcePolicyBannerInline extends StatelessWidget {
  const SourcePolicyBannerInline({super.key});
  @override
  Widget build(BuildContext context) {
    // Import from source_policy_banner.dart at call site if needed.
    // This avoids a circular import; the real widget is in widgets/source_policy_banner.dart.

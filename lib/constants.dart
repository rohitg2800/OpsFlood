class AppConstants {
  ...
  // ─── Polling / retry ─────────────────────────────────────────────
  // 45 s interval reduces Render free-tier hammering (was 30 s).
  static const Duration pollingInterval = Duration(seconds: 45);
  static const int      maxRetries      = 3;

  // ─── Default river gauge levels (metres, CWC HMS scale) ──────────────
  // Used only in FloodData.fromMonitoredCity() when no backend data is
  // available. Values are representative CWC-scale averages for Indian rivers.
  // Real per-city values come from the live backend.
  static const double defaultDangerLevel  = 10.0; // was 3.0 — far too small
  static const double defaultWarningLevel =  8.0; // was 2.5
  static const double defaultSafeLevel    =  5.0; // was 1.5
  ...
  // ─── Indian states + UTs (display names) ───────────────────────────

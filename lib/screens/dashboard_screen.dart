...
class _DashboardScreenState extends State<DashboardScreen>
  ...
  bool _showDebug      = false;   // toggled by debug FAB
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          const Text('live-telemetry (CWC) response:',
              style: TextStyle(color: Colors.white38, fontSize: 10)),
          const SizedBox(height: 4),
        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              Text('$stationCount stations above warning level \u00b7 via backend proxy',
                  style: const TextStyle(color: Colors.white70, fontSize: 11)),
            ],
          ),
        ),
    ...
    return Column(
      ...
      children: [
        Text('\u26a0 CWC Stations Above Warning Level',
            style: TextStyle(
                color: rc.textPrimary, fontWeight: FontWeight.w700, fontSize: 13)),
        const SizedBox(height: 8),
        SizedBox(
          height: 104,
          child: ListView.separated(
            ...
            itemBuilder: (_, i) {
              ...
              final displayName = s.stationName.isNotEmpty
                  ? s.stationName
                  : s.riverName.isNotEmpty ? s.riverName : 'Station ${i + 1}';
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (s.riverName.isNotEmpty)
                      Text(s.riverName, maxLines: 1, overflow: TextOverflow.ellipsis,
                          style: TextStyle(
                              color: rc.textSecondary.withValues(alpha: 0.75), fontSize: 9)),
                    const SizedBox(height: 4),
                    Row(
                      children: [
                        ...
                        Icon(
                          s.trend == 'RISING' ? Icons.trending_up
                              : s.trend == 'FALLING' ? Icons.trending_down
                              : Icons.trending_flat,
                          color: color, size: 14),
                      ],
                    ),
...
class _ModelMetricsCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (loading) {
      return Container(
        height: 52, margin: const EdgeInsets.only(bottom: 4),
        ...
        children: [
          ...
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(algo, style: TextStyle(color: rc.textPrimary,
...
class _TrendCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: rc.cardBg, borderRadius: BorderRadius.circular(18),
          ...
          Expanded(
            child: spots.length < 2
                ...
                : LineChart(LineChartData(
                    ...
                    titlesData: FlTitlesData(
                      ...
                      bottomTitles: AxisTitles(sideTitles: SideTitles(
                        ...
                        getTitlesWidget: (v, _) {
                          ...
                          if (v == ((spots.length - 1) / 2).roundToDouble()) return Text('Mid', style: TextStyle(color: rc.textSecondary, fontSize: 10));
                          if (v == (spots.length - 1).toDouble()) return Text('Now', style: TextStyle(color: rc.textSecondary, fontSize: 10));
                    ...
                    lineBarsData: [
                      LineChartBarData(
                        spots: spots, isCurved: true, color: rc.sparklineColor, barWidth: 3,
                    ...
                    extraLinesData: ExtraLinesData(
                      horizontalLines: [
                        HorizontalLine(y: warningLevel, color: const Color(0xFFF59E0B),
                            strokeWidth: 1.3, dashArray: [4, 4]),
                        HorizontalLine(y: dangerLevel,  color: const Color(0xFFEF4444),

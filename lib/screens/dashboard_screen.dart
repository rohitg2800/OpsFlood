                ...
                sliver: SliverList(
                  delegate: SliverChildListDelegate([
                    ...
                    Row(
                      children: [
                        ...
                        IconButton(
                          ...
                          icon: Icon(Icons.refresh, color: rc.textSecondary, size: 22),
                        ),
                      ],
                    ),
                    ...
                    if (cwcStations.isNotEmpty) ...[
                      _CwcStationStrip(
                          stations: cwcStations.take(8).toList()),
                      const SizedBox(height: 16),
                    ],
...
class _ModelMetricsCard extends StatelessWidget {
  ...
  const _ModelMetricsCard(
      {required this.loading, required this.metrics});
                ...
                : LineChart(LineChartData(
                    ...
                    gridData: FlGridData(
                      ...
                      getDrawingHorizontalLine: (_) => FlLine(
                          color:
                              rc.riverNormal.withValues(alpha: 0.1),
                          strokeWidth: 1),
                    ),

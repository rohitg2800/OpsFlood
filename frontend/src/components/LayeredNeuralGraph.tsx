...
export const LayeredNeuralGraph: React.FC<LayeredNeuralGraphProps> = ({
  ...
  const inputLeadX = compact ? 14 : 20;
  const outputTrailX = compact ? width - 14 : width - 18;
  const inputX = width * 0.17;
  const hiddenAX = width * 0.44;
  const hiddenBX = width * 0.69;
  const outputX = width * 0.87;

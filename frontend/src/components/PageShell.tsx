...
export const PageHero: React.FC<PageHeroProps> = ({
  ...
  <div className="flex flex-col gap-5 rounded-lg border border-[#ff0037]/30 bg-[#151d16]/88 px-6 py-6 backdrop-blur-2xl shadow-[0_20px_60px_rgba(0,0,0,0.35)] sm:px-8">
    <div className={`flex gap-3 ${centered ? 'flex-col items-center text-center' : 'items-center'}`}>
      <div className="flex h-12 w-12 items-center justify-center rounded-md border border-[#ff0037]/35 bg-gradient-to-br from-[#2f171b] via-[#571a26] to-[#9c2438] shadow-[0_12px_30px_rgba(255,0,55,0.16)]">
...
export const PageCard: React.FC<PageCardProps> = ({ children, className = '', padded = true }) => (
  <div
    className={`overflow-hidden rounded-lg border border-[#ff0037]/28 bg-[#121812]/90 backdrop-blur-3xl shadow-[0_24px_80px_rgba(0,0,0,0.45)] ${padded ? 'p-8 sm:p-10' : ''} ${className}`}
  >
    {children}
  </div>
);
